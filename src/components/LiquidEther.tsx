    ...
    class Output {
      ...
      update() {
        ...
        if (material && material.uniforms) {
          material.uniforms.velocity.value = this.simulation.fbos.vel_0.texture;
          material.uniforms.boundarySpace.value = this.simulation.boundarySpace;
        }
        this.render();
      }
    }
    ...
    class WebGLManager {
      ...
      init() {
        ...
        this.output = new Output({
          iterations_poisson: this.props.iterationsPoisson || 32,
          iterations_viscous: this.props.iterationsViscous || 32,
          mouse_force: this.props.mouseForce || 20,
          resolution: this.props.resolution || 0.5,
          cursor_size: this.props.cursorSize || 100,
          viscous: this.props.viscous || 30,
          isBounce: this.props.isBounce || false,
          dt: this.props.dt || 0.014,
          isViscous: this.props.isViscous || false,
          BFECC: this.props.BFECC !== false
        });
      }
